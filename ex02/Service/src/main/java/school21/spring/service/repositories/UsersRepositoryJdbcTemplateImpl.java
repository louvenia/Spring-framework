...
public class UsersRepositoryJdbcTemplateImpl implements UsersRepository {
    ...
    @Autowired
    public UsersRepositoryJdbcTemplateImpl(@Qualifier("dataSource")DataSource ds) {
    ...
    public void save(User entity) {
        ds.update("insert into users(email, password) values(:email, :password);", new MapSqlParameterSource("email", entity.getEmail()).addValue("password", entity.getPassword()));
    }
